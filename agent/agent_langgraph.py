...
_COMPARE_SYS = (
    ...
    "(je (Domain) + Guete-Markierung [vertrauenswuerdig] / [niedrig] / ohne = neutral). "
    "Fuer JEDE pruefbare Aussage des Entwurfs gib GENAU diesen Block aus:\n"
    "<knappe Aussage>\n"
    ...
    "Gewichtung: [vertrauenswuerdig] zaehlt STARK, [niedrig] schwach. Stuetzen NUR "
    "[niedrig]-Quellen, vergib NICHT [BESTAETIGT], sondern kennzeichne niedrige Konfidenz.\n"
